<template>
  <div id="app">
    ...
    <router-view/>
    <app-footer />
    <modal name="modal-signup" transition="pop-out" :width="modalWidth" :focus-trap="true" :height="400">
      <div class="box">
...
.box {
  ...
  .box-part {
    ...
    width: 50%;
    &#bp-right {
      background: url('http://vue-js-modal.yev.io/static/panorama.jpg') no-repeat top left;
